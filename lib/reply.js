...
function buildReply (ParentReply) {
...
function onSendEnd (reply, payload) {
  ...
  if (typeof payload !== 'string' && !Buffer.isBuffer(payload)) {
    ...
    throw new TypeError(`Attempted to send payload of invalid type '${typeof payload}'. Expected a string, Buffer, or stream.`)
  }
...
function notFound (reply) {
  ...
  if (reply.context._fastify === null) { // not-found handler called inside a not-found handler
