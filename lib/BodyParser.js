...
BodyParser.prototype.run = function(
  ...
  if (parser.asString === true || parser.asBuffer === true) {
    ...
    rawBody(request, response, parser, contentLength, bodyLimit, done)
  } else {
    var result = parser.fn(request.stream, done)
...
function rawBody(request, response, parser, contentLength, bodyLimit, done) {
  var {stream} = request
  var {asString} = parser
